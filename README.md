...
>
> The middleware with a higher priority value runs first. Conversely, if you need to create a middleware that runs
...
> for more information about using the container inside a middleware.
...
| `getAll(options)`             | **`options`**: Same as `get(key, options)` method.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Gets all services and return them as an object. Each service, of this object, is wrapped in a callback function, and called on demand when call this function. |
